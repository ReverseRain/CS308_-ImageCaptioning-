...
from .vision_encoder.clip_encoder import CLIPVisionEncoder
from .multimodal_projector.projector import build_projector
from .language_model.utils import process_inputs_for_generation

# 定义常量
IGNORE_INDEX = -100  # 用于忽略损失计算中的某些位置

class ImageCapConfig:
    """图像描述生成模型的配置类"""
...
class ImageCapModel(nn.Module):
    ...
    def from_pretrained(cls, model_path, device=None):
        ...
        # 创建配置
        config = ImageCapConfig.from_dict(config_dict)
