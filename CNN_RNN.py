...
class VLMModel(nn.Module):
    def __init__(self, vision_embed_size, language_model_name="Qwen/Qwen3-0.6B"):
        super().__init__()
        # 视觉编码器
        self.encoder = CNNEncoder(vision_embed_size)
    ...
    def forward(self, images, text_input_ids=None):
        ...
        if text_input_ids is not None:
            ...
            # 扩展视觉特征以匹配文本特征的形状
            vision_projection = vision_projection.unsqueeze(1)  # [batch_size, 1, language_embed_size]
